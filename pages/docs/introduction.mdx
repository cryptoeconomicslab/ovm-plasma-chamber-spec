...
Gazelle is a scaling technology for blockchain based on Plasma and Optimistic Virtual Machine(OVM). Current scope of its functionality includes transfer of WrappedETH[^1] and ERC20 tokens.
